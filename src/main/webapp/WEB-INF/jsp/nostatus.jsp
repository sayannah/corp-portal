...
<div>
		...
		<div class="jumbotron" id="content">
			<div class="container">
				...
				<div id="offerbutton">
					<a class="btn btn-primary btn-pink btn-lg" href="addOffer" role="button">Click
			  ...
			  <section class="subscribe">
			              <div class="container" data-aos="fade-up">
			                    <div class="row" >
			     <script>alert("Offer already engaged!"); </script>
					             ...
					             <div class="col-md-4">
									...
									<div class="card-body">
											...
											<table>
												...
												<tr>
													<td>
														<a class="btn btn--green btn--pill btn-primary" id="clickbutton"
															href='addlike?offerId=<c:out value="${offer.offerId}"></c:out>'>
															<role="button">Like &raquo; 
														</a>
													</td>
													<td>
														<a class="btn btn--green btn--pill btn-primary" id="editkbutton" 
															href='engage?offerId=<c:out value="${offer.offerId}"></c:out>&empId=<c:out value="${offer.empId}"></c:out>'>
															<role="button">Engage &raquo;  <script>alert("Offer engaged Successfully!");
                                                          </script>
														</a>
													</td>
												</tr>
