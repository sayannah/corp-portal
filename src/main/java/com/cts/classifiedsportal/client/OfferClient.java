...
public interface OfferClient {
	...
	public ResponseEntity<Offer> getOfferDetails(@RequestHeader(name = "Authorization") String token, @PathVariable("id") int id);
	...
	@PostMapping("/updateLikes/{offerid}/{employeeid}")
	...
	public ResponseEntity<?> engageOffer(@RequestHeader(name = "Authorization") String token, @PathVariable("oId") int offerId, @PathVariable("id") int empid);
	
	@PostMapping("/editoffer/{id}")
	public ResponseEntity<?> editOffer(@RequestHeader(name = "Authorization") String token, @RequestBody Offer offer, @PathVariable("id") int id);
