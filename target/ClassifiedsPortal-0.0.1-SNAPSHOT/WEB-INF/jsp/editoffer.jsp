...
<body class="text-center">
	...
	<main class="form-signin" id="main">
		<form name="addoffer" method="post" action="/editOffer" onsubmit="return validateForm()" >
			<div class="jumbotron" id="content">
				<div class="container">
					<h1 class="display-6">Edit Your Offer</h1>
				</div>
			</div>
			<div id="content1">
				...
				<button class="w-100 btn btn-lg btn-primary" type="submit" >Edit offer</button>
		</form>
	</main>
	</div>
