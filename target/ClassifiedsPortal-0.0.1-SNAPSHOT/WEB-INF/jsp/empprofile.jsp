...
<body>
	...
	<main role="main">
		...
		<div class="jumbotron" id="content">
			<div class="container">
				<h1 class="display-6" align="center" style="margin-top:15px;">Your Profile</h1>
			</div>
		</div>
		<div id="subscribe">
					...
					<div class="col-md-3">
						<div class="card">
							<div class="card-body">
								...
								<h5>Employee Id:${employee.empId}</h5>
								<h5>${employee.empEmail}</h5>
								<h5>Points Gained:${points}</h5>
							</div>
						</div>
						<div id="addbutton">
							<a class="btn btn-primary btn-lg btn--green" href="addOffer" role="button">Post
								a New Offer &raquo;</a>
						</div>
					</div>
			</section>
